...
There is another **optional** argument available to adjust the block times within the protocol limits. The default value of this argument is set to 0 which translates to 400ms block times. You can set it to a max of 50 which translates to 350ms
